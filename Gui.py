...
class Gui(Frame):
    ...
    def Select_Ok(self,v):
        if(self.t1.get() != "" and self.t2.get() != ""):
            ...
            #chamando a função para calcular a similaridade de acordo com os pesos escolhidos
            funcMain.run(num1,num2,int(selection))
    ...
    def btnOptions(self,cv1):
        ...
        v = IntVar()
        Radiobutton(menu, text="LCH", variable=v, value=1,bg='#E8E8E8').place(x=80,y=100,anchor=W)
        Radiobutton(menu, text="WUP", variable=v, value=2,bg='#E8E8E8').place(x=80,y=130,anchor=W)
        Radiobutton(menu, text="PATH", variable=v, value=3,bg='#E8E8E8').place(x=80,y=160,anchor=W)
        Radiobutton(menu, text="RES", variable=v, value=4,bg='#E8E8E8').place(x=80,y=190,anchor=W)
        Radiobutton(menu, text="JCN", variable=v, value=5,bg='#E8E8E8').place(x=80,y=220,anchor=W)
        Radiobutton(menu, text="LIN", variable=v, value=6,bg='#E8E8E8').place(x=80,y=250,anchor=W)
